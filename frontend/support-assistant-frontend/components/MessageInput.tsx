    ...
    <div className="p-4 border-t border-gray-300">
      <div className="flex gap-2">
        ...
        <input
          ...
          disabled={disabled}
          className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
        />
        <button
          onClick={handleSend}
